  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        Provider(
          lazy: false, // Já irá instanciar a classe, assim que o app for aberto
          create: (_) => SqliteConnectionFactory(),
        ),
        Provider<UserRepository>(
          create: (BuildContext context) => UserRepositoryImpl(
            firebaseAuth: context.read(),
          ),
        ),
        Provider<UserService>(
          create: (BuildContext context) => UserServiceImpl(
